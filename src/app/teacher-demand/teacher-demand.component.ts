...
export class TeacherDemandComponent implements OnInit {
  ...
  ngOnInit() {
    this.teacherDemands = [
      ...
      {groups: [{group_cod: '1', type: 'practica de aula',}, {group_cod: '2', type: 'practica de laboratorio', group_id: 2}],
        course: '1', name: 'ANALISIS MATEMATICO', semester: '1', subject_cod: '40304', type: 'Básica Rama', university_degree_cod: '4003',
        university_degrees_name: 'Grado en Traduc. e Interpretación: Inglés-Alemán'},
      {groups: [{group_cod: '1', type: 'practica de aula',}, {group_cod: '2', type: 'practica de teoria', group_id: 2}],
      ...
      {groups: [{group_cod: '1', type: 'practica de aula',}, {group_cod: '2', type: 'practica de aula', group_id: 2}],
        ...
        university_degrees_name: 'Grado en Traduc. e Interpretación: Inglés-Alemán'},{groups: [{group_cod: '1', type: 'teoria',}, {group_cod: '2', type: 'practica de aula', group_id: 2}],
        course: '1', name: 'ESTRUCTURA DE COMPUTADORES', semester: '1', subject_cod: '40304', type: 'Básica Rama', university_degree_cod: '4003',
        university_degrees_name: 'Grado en Computacion'},{groups: [{group_cod: '1', type: 'practica de aula',}, {group_cod: '2', type: 'practica de aula', group_id: 2}],
